# Author: Jacob Dawson
#
# this file stores the songs to be translated to/from, as well as data about
# the languages we can choose from. Seperated out from the main script for
# aesthetic purposes mostly
